...
class TestPermissionsAPI:
    ...
    def test_list_bot_collaborators(self, client: TestClient, db_session: Session, sample_user: User, sample_bot: Bot, auth_headers):
    ...
    def test_grant_bot_permission(self, client: TestClient, db_session: Session, sample_user: User, sample_bot: Bot, auth_headers):
        """Test granting permission to a user."""
        # Create admin permission for granter
